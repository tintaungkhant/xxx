                ...
                if (league_select_frame) {
                    ...
                    for (let index = 0; index < selectable_leagues.length; index++) {
                        ...
                        if (selectable_league_name) {
                            if (!this.isSideMarketLeague(selectable_league_name) && !this.isEsportLeague(selectable_league_name)) {
                ...
                if (table) {
                    ...
                    for (let index_1 = 0; index_1 < league_tbodies.length; index_1++) {
                        ...
                        if (league_tr) {
                            ...
                            if (!this.isSideMarketLeague(league_name) && !this.isEsportLeague(league_name)) {
                                let fixtures = [];
